        ...
        with open(input_file, 'r') as input_file:
            ...
            for row in reader:
                ...
                time_stamp, smoker_temp, foodA_temp, foodB_temp = row
                 ...
                 #if there is no temperature, say 'No temp recorded'
                if smoker_temp == '':
                    smoker_temp = 'temp not recorded'
                if foodA_temp == '':
                    foodA_temp = 'temp not recorded'
                if foodB_temp == '':
                    foodB_temp = 'temp not recorded'
                ...
                print(f" [x] Sent {message1} to {queue1}")
                ...
                print(f" [x] Sent {message2} to {queue2}")
                ...
                print(f" [x] Sent {message3} to {queue3}")
