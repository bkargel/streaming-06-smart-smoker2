...
foodA_alert_time = 10.0
alert = "Alert!! Food stall! FoodA temperature has changed by less than 1 degree in 10 minutes!"
...
def foodA_callback(ch, method, properties, body):
    ...
    print(f" [x] FoodA temperature is {foodA_temp[1]} at {foodA_temp[0]}")
    ...
    if len(foodA_deque) % 20 == 0:
            foodA_deque.clear()    

# define a main function to run the program
def main(HOST: str, queue2: str):
    ...
    try:
        ...
        ch.basic_consume(queue2, foodA_callback, auto_ack=False)
